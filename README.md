...
| **B站数据** | **UP 主视频数据爬取、粉丝/播放量趋势图、全局视频搜索** |
...
| **B站数据** | **UP 主管理、扫码登录、视频爬取、粉丝/播放量趋势图表、数据刷新** |
...
│   │   ├── __init__.py        # 包标记
│   │   ├── config.py          # 请求间隔/Cookie 路径/UA
│   │   ├── bili_api.py        # B站 API 封装（视频列表/统计/用户信息）
