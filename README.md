...
推荐在生产环境通过环境变量配置密钥和数据库：

```bash
export SECRET_KEY='your-strong-secret-key'
export DATABASE_URL='mysql+pymysql://user:pass@localhost/hoshino_blog'
